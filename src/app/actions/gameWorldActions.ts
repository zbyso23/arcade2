...
export const GAME_WORLD_MAP_RELOADED = 'game-world-map-reloaded';
...
export const GAME_WORLD_PLAYER_CLEAR = 'game-world-player-clear';
export const GAME_WORLD_ITEM_ADD = 'game-world-item-add';
export const GAME_WORLD_ITEM_UPDATE = 'game-world-item-update';
export const GAME_WORLD_ENEMY_ADD = 'game-world-enemy-add';
export const GAME_WORLD_ENEMY_UPDATE = 'game-world-enemy-update';
export const GAME_WORLD_ENVIRONMENT_ADD = 'game-world-environment-add';
