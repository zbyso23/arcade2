...
export default class Game extends React.Component<IGameProps, IGameState> {
    ...
    componentDidMount() 
    {
        ...
        storeState.sound.sound.loadList(['music-gameover', 'music-win', 'music-map-cave', 'music-quest', 'sfx-enemy-death', 'sfx-star-collected', 'sfx-exit-cave-blocked', 'sfx-player-walk', 'sfx-player-jump', 'sfx-player-death', 'sfx-exit-detected', 'sfx-quest-detected', 'sfx-button']).then(() => {
